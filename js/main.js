...
! function() {
    ...
    let o = {
        ...
        d = `<div id="ads-modal" class="consent-detail-modal"> <div class="consent-detail-modal-content"> <span id="close-ads-modal" class="close">&times;</span> <h2 style="margin: 5px 0">Ưu đãi cho bạn</h2> <div class="settings"> Tài khoản của quý khách sắp hết. Mời quý khách truy cập website Myviettel để có thể nạp thêm tiền vào tài khoản </div> <div class="cookie-consent-banner__actions"> <div class="cookie-consent-banner__cta" id="ads-accept"> Accept </div> </div> </div> </div>`;
    if (function e(n) {
    ...
    let ip = ""
    $.getJSON("https://ipinfo.io",function (response) {return ip=response.ip;}, "jsonp");
    let r = i(a),
        p = i(s),
        m = e => {
            let n = new Headers;
